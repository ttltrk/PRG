...
<h3 id='^'>Python - Packages/Modules/Files - Packages/Modules</h3>
...
download --> get-pip.py
launch --> get-pip.py
in cmd --> py -m pip install <pkg_name> (in anaconda prompt)
```

---

<h4 id='py2exe'>Python to .exe</h4>
