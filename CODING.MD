...
DIR - 2
  ...
  * JAN
    ...
    * 25 : (Thu) 
      + [Udemy](https://www.udemy.com/complete-python-bootcamp/learn/v4/t/lecture/3512850?start=15) Finished enumerate() section. Updated 
      + [OPyM](https://github.com/ttltrk/PRG/blob/master/PY/DOC/OPYM/04_MET_FUN/FUNCTIONS/BIF/ENUMERATE.MD). 66% - Complete Python Bootcamp: Go from zero to hero in Python.
      + Codecademy to 50.
